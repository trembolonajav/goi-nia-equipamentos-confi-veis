...
const SELOS = [
  { icon: Clock, label: "Orçamento em até 15 min no horário comercial" },
...
export function Hero() {
  return (
    <section id="top" className="relative isolate overflow-hidden">
      ...
      <div className="container-locago flex min-h-[440px] flex-col justify-center py-12 lg:min-h-[520px] lg:py-16">
        <p className="eyebrow">Locação de equipamentos · {EMPRESA.cidade}</p>
        <h1 className="mt-4 max-w-3xl text-[clamp(2rem,5vw,3.5rem)] uppercase">
        ...
        <p className="mt-4 max-w-xl text-lg text-muted-foreground">
          ...
          semanal ou mensal em Goiânia e região. Revisado, entregue no prazo.
        </p>
